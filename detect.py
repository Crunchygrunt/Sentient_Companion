...
def get_gender(frame, num_iterations=5):
    gender_results = []
    for _ in range(num_iterations):
        ...
        if faceBoxes:
            ...
            gender_results.append(None)

    if gender_results:
        dominant_gender = Counter(gender_results).most_common(1)[0][0]
...
def main():
    ...
    hasFrame, frame = video.read()
    if hasFrame:
        dominant_gender = get_gender(frame, num_iterations=5)
